...
Perhaps this is a first-principles relic of my physics education, but I believe that technical teams of any sort can reap tremendous benefits by simply mapping out their processes. I like to call these maps *technical product roadmaps*. The map should use plain words (no code!) to explain each step of a program or analysis.
